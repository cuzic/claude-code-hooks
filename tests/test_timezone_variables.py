...
class TestTimezoneVariables:
    ...
    @patch.dict("claude_code_pushbullet_notify.config.CONFIG", {"notification": {"timezone": "UTC"}})
    ...
    @patch.dict("claude_code_pushbullet_notify.config.CONFIG", {"notification": {"timezone": "Asia/Tokyo"}})
    @patch("claude_code_pushbullet_notify.template.datetime")
    ...
    @patch.dict("claude_code_pushbullet_notify.config.CONFIG", {"notification": {"timezone": "America/New_York"}})
    @patch("claude_code_pushbullet_notify.template.datetime")
    ...
    @patch.dict("claude_code_pushbullet_notify.config.CONFIG", {"notification": {"timezone": "Invalid/Timezone"}})
    @patch("claude_code_pushbullet_notify.template.datetime")
    ...
    @patch.dict("claude_code_pushbullet_notify.config.CONFIG", {"notification": {"timezone": "Europe/London"}})
    @patch("claude_code_pushbullet_notify.template.datetime")
    ...
    @patch.dict("claude_code_pushbullet_notify.config.CONFIG", {"notification": {"timezone": "Australia/Sydney"}})
    @patch("claude_code_pushbullet_notify.template.datetime")
