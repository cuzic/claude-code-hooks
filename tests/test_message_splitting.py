...
from claude_code_pushbullet_notify.transcript import _add_part_numbers_to_title, _split_message_into_chunks
...
class TestSplitNotifications:
    ...
    def test_send_split_notifications_explicit_params(self, mock_send):
        ...
        result = send_split_notifications("Test Title", long_message, max_length=30, split_enabled=True)
