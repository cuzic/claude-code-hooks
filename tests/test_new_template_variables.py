...
class TestNewTemplateVariables:
    ...
    def test_send_notification_with_all_new_variables(
        self, mock_getcwd, mock_hostname, mock_config, mock_send
    ):
    ...
    def test_template_with_cwd_basename(self, mock_getcwd, mock_config, mock_send):
        ...
        mock_config.get.return_value = {
            "title_template": "Project: {CWD_BASENAME} - {GIT_REPO}"
        }
        mock_send.return_value = True
